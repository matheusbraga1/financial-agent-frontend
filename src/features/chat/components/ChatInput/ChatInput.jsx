...
const ChatInput = ({ onSendMessage, isLoading }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-3xl mx-auto">
      <div className="relative bg-white dark:bg-dark-card rounded-2xl border-2 border-gray-200 dark:border-dark-border shadow-lg hover:border-gray-300 dark:hover:border-primary-700 focus-within:!border-primary-500 dark:focus-within:!border-primary-400 focus-within:ring-4 focus-within:ring-primary-100 dark:focus-within:ring-primary-500/20 focus-within:shadow-xl dark:focus-within:shadow-primary-900/50 transition-all duration-300 ease-in-out">
        <textarea
          ref={textareaRef}
          value={input}
          ...
          {isNearLimit && (
            <div
              className={`text-xs px-2 py-1 rounded-md transition-colors ${
                isNearLimit ? 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 font-medium' : 'text-gray-400 dark:text-gray-500'
              }`}
              aria-live="polite"
            >
              {remainingChars}
      ...
      {/* Dica de atalho */}
      <div className="mt-2 text-center text-xs text-gray-500 dark:text-gray-400 transition-colors">
